...
//  Printf("Entered the mainfunction of makeprocs.c\n");
  ...
  cBufPtr->s_fullslots = sem_create(0);
  cBufPtr->s_emptyslots = sem_create(BUFFER_SIZE);

//  Printf("Sem crated for fullslots = %d\n and sem created for emptyslots = %d\n",cBufPtr->s_fullslots,cBufPtr->s_emptyslots);
  //Exit();
